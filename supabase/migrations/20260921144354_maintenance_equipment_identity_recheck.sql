-- Forward refinement: stale identity labels, conflicting explicit mappings, marker changes.
...
CREATE OR REPLACE FUNCTION public.register_maintenance_equipment_replacement(
