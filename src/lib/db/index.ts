...
const materialAdapter = hasSupabase
  ...
  : {
      ...
      listProjectMaterialBatchesForReminder: requireMaterialsSupabase('listProjectMaterialBatchesForReminder'),
      ...
      updateMaterialReceiptPlan: requireMaterialsSupabase('updateMaterialReceiptPlan'),
      setMaterialBatchSameDay: requireMaterialsSupabase('setMaterialBatchSameDay'),
      updateMaterialReceiptOverride: requireMaterialsSupabase('updateMaterialReceiptOverride'),
      rescheduleMaterialReceiptGroup: requireMaterialsSupabase('rescheduleMaterialReceiptGroup'),
      completeMaterialReceiptSchedule: requireMaterialsSupabase('completeMaterialReceiptSchedule'),
      ...
      listProjectMaterialsByBatchIds: requireMaterialsSupabase('listProjectMaterialsByBatchIds'),
      listMaterialReceivingBatches: requireMaterialsSupabase('listMaterialReceivingBatches'),
      listOfficeProjectMaterials: requireMaterialsSupabase('listOfficeProjectMaterials'),
      listMaterialReceipts: requireMaterialsSupabase('listMaterialReceipts'),
      confirmMaterialReceipt: requireMaterialsSupabase('confirmMaterialReceipt'),
      reverseMaterialReceipt: requireMaterialsSupabase('reverseMaterialReceipt'),
...
const workflowAdapter = hasSupabase
  ? {
      ...
      getProjectWorkflowRefreshPreview: pocSupabaseAdapter.getProjectWorkflowRefreshPreview,
      refreshProjectWorkflow: pocSupabaseAdapter.refreshProjectWorkflow,
      ...
      getPositions: pocSupabaseAdapter.getPositions,
      createPosition: pocSupabaseAdapter.createPosition,
      updatePosition: pocSupabaseAdapter.updatePosition,
      getMemberPositions: pocSupabaseAdapter.getMemberPositions,
      setMemberPositions: pocSupabaseAdapter.setMemberPositions,
      getPositionCandidates: pocSupabaseAdapter.getPositionCandidates,
      getProjectResponsiblePositions: pocSupabaseAdapter.getProjectResponsiblePositions,
      getProjectPositionAssignments: pocSupabaseAdapter.getProjectPositionAssignments,
      upsertProjectPositionAssignment: pocSupabaseAdapter.upsertProjectPositionAssignment,
      clearProjectPositionAssignment: pocSupabaseAdapter.clearProjectPositionAssignment,
      setProjectPositionAssignment: pocSupabaseAdapter.setProjectPositionAssignment,
      getMemberProjectResponsibilities: pocSupabaseAdapter.getMemberProjectResponsibilities,
  ...
  : {
      ...
      getProjectWorkflowRefreshPreview: requireWorkflowSupabase('getProjectWorkflowRefreshPreview'),
      refreshProjectWorkflow: requireWorkflowSupabase('refreshProjectWorkflow'),
      ...
      getPositions: requireWorkflowSupabase('getPositions'),
      createPosition: requireWorkflowSupabase('createPosition'),
      updatePosition: requireWorkflowSupabase('updatePosition'),
      getMemberPositions: requireWorkflowSupabase('getMemberPositions'),
      setMemberPositions: requireWorkflowSupabase('setMemberPositions'),
      getPositionCandidates: requireWorkflowSupabase('getPositionCandidates'),
      getProjectResponsiblePositions: requireWorkflowSupabase('getProjectResponsiblePositions'),
      getProjectPositionAssignments: requireWorkflowSupabase('getProjectPositionAssignments'),
      upsertProjectPositionAssignment: requireWorkflowSupabase('upsertProjectPositionAssignment'),
      clearProjectPositionAssignment: requireWorkflowSupabase('clearProjectPositionAssignment'),
      setProjectPositionAssignment: requireWorkflowSupabase('setProjectPositionAssignment'),
      getMemberProjectResponsibilities: requireWorkflowSupabase('getMemberProjectResponsibilities'),
